...
//https://react-kakao-maps-sdk.jaeseokim.dev/docs/sample/overlay/multipleMarkerEvent/
      ...
      <div class="flex flex-col flex-grow h-4/5 m-auto w-1/5 max-w-xl bg-white shadow-xl rounded-lg relative ">
        ...
        <section id="bottom-navigation" class="absolute border-slate-300 shadow-xl rounded-lg inset-x-0 bottom-0 bg-white ">
          <div id="tabs" class="flex justify-between ">
            ...
            <div onClick={toMap} class="w-full text-[#C80150] justify-center inline-block text-center pt-2 pb-1">
              <svg width="25" height="25" viewBox="0 0 42 42" class="inline-block mb-1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <div onClick={toRank} class="w-full focus:text-slate-300 hover:text-slate-300 justify-center inline-block text-center pt-2 pb-1">
              <svg width="25" height="25" viewBox="0 0 42 42" class="inline-block mb-1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
